...
function Button({children, disabled, to, type}) {
    const base = "bg-yellow-400 font-semibold text-stone-800  inline-block tracking-wide rounded-full uppercase hover:bg-yellow-300 transition-colors duration-300 focus:ring focus:ring-yellow-300 focus:ring-offset-2 focus:bg-yellow-300 focus:outline-none disabled:cursor-not-allowed";
    const styles = {
